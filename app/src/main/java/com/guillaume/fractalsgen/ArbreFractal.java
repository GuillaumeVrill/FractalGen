...
public class ArbreFractal {
    ...
    public void drawArbre(Canvas c, int x1, int y1, double angle, int longueur){
        if(longueur <= 0)
            return;
        ...
        drawArbre(c, x2, y2, angle1, longueur-longToSoustract);
        drawArbre(c, x2, y2, angle2, longueur - longToSoustract);
    }
